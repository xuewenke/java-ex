...
import com.x.atrs.util.system.dto.CpuInfo;
...
public class OshiUtil {
     ...
     * @return
     */
    public static HWDiskStore getDiskByName(String name) {
        List<HWDiskStore> diskStores = getDiskStores();
        for (HWDiskStore diskStore : diskStores) {
            if (Objects.equals(name, diskStore.getName())) {
                return diskStore;
            }
        }
        throw new RuntimeException("not found disk by name  name = [{}]" + name);
    }
     ...
     * @return
     */
    public static String getDiskNameByMount(String mount) {
        List<OSFileStore> fileStores = os.getFileSystem().getFileStores();
        for (OSFileStore fileStore : fileStores) {
            if (Objects.equals(mount, fileStore.getMount())) {
                return fileStore.getLogicalVolume();
            }
        }
        throw new RuntimeException("not found diskname  by mount = [{}]" + mount);
    }
